...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "KS CRM é uma plataforma SaaS multi-tenant de CRM inteligente com IA." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "KS CRM - CRM Inteligente com IA" },
      { name: "twitter:description", content: "KS CRM é uma plataforma SaaS multi-tenant de CRM inteligente com IA." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Instrument+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap" },
      { rel: "stylesheet", href: "https://api.fontshare.com/v2/css?f[]=satoshi@400,500,600,700,900&f[]=general-sans@400,500,600,700&display=swap" },
